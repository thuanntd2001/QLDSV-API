		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a
					href="quanly/pgv/sinhvien">Sinh Viên</a></li>
				<li class="breadcrumb-item active">Xóa Sinh Viên</li>
			</ol>
		</nav>
	</div>
			...
			<div class="col-lg-5">
				...
				<div class="card">
					<div class="card-body">
						...
						<form action="quanly/pgv/sinhvien/xoa?id=${id }" method="post"
							class="row g-3">
							<div  class="col-md-12" style="align-items=center;">
								<label for="inputEmail5" class="form-label">Bạn có đồng ý xoá Sinh Viên ${id }</label>
							</div>
