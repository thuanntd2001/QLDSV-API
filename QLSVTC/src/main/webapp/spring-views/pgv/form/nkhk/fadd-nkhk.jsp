...
<body>
	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="quanly/pgv/nkhk">Niên
						khóa - Học kỳ</a></li>
			...
			<div class="col-lg-10">
				...
				<div class="card">
					<div class="card-body">
						...
						<form:form action="quanly/pgv/nkhk/add" method="post"
							...
							<div class="col-md-4">
								<label for="inputState" class="form-label">Ngày mở đăng
									ký</label> <br>
								<form:input path="ngayMoDK" />
								<br>
							</div>
							<div class="col-md-4">
								<label for="inputState" class="form-label">Ngày đóng
									đăng ký</label> <br>
