	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Xóa Niên khóa - Học kỳ</li>
			</ol>
		</nav>
	</div>
	<section class="section">
		<div class="row">
			<div class="col-lg-5">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Xóa Niên khóa - Học kỳ</h5>
						${message} 
						
						<form action="quanly/pgv/nkhk/xoa?id=${id }" method="post"
							class="row g-3">
							<div  class="col-md-12" style="align-items=center;">
								<label for="inputEmail5" class="form-label">Bạn có đồng ý xoá Niên khóa - Học kỳ ${id }</label>
							</div>
