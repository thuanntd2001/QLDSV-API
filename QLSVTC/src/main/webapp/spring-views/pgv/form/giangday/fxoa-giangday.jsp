		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a
					href="quanly/pgv/giangday">Giảng viên</a></li>
				<li class="breadcrumb-item active">Xóa Giảng viên</li>
			</ol>
		</nav>
	</div>
	<section class="section">
		<div class="row">
			<div class="col-lg-5">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Xóa Lịch Giảng viên</h5>
						${message} 
						
						<form action="quanly/pgv/giangday/xoa?id=${id }" method="post"
							class="row g-3">
							<div  class="col-md-12" style="align-items=center;">
								<label for="inputEmail5" class="form-label">Bạn có đồng ý xoá Giảng viên ${id }</label>
							</div>
