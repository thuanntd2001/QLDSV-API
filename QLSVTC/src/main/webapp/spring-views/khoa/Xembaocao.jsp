						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td><a href="xembaocao/bcbangdiemmonhocltc/khoa"
										class="fa fa-eye"></a></td>
								</tr>
								<tr>
									<th scope="row">Danh sách lớp tín chỉ</th>
									<td><a href="xembaocao/bcdsltc/khoa" class="fa fa-eye"></a></td>
								</tr>
								<tr>
									<th scope="row">Danh sách sinh viên đăng ký lớp tín chỉ</th>
									<td><a
										href="xembaocao/bcdssvdkltc/khoa"
										class="fa fa-eye"></a></td>
								</tr>
								<tr>
									<th scope="row">Phiếu Điểm</th>
									<td><a
										href="xembaocao/bcphieudiem/khoa"
										class="fa fa-eye"></a></td>
								</tr>
								<tr>
