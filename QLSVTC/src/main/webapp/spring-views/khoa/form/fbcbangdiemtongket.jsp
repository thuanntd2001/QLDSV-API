	...
	<section class="section">
		<div class="row">
			<div class="col-lg-10">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Bảng điểm tổng kết</h5>
						${message}


						<form:form action="xembaocao/bcbangdiemtongket/khoa" method="post"
							modelAttribute="para" class="row g-3">
							

							<div class="col-md-10">
								<label for="inputEmail5" class="form-label">Mã Lớp</label>
								<form:input path="maLop" class="form-control" id="inputEmail5" />
							</div>
